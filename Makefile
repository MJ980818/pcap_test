...
# Template: app
# Command: /home/minjeong/Qt/5.13.0/gcc_64/bin/qmake -o Makefile ../pcap_test/pcap_test.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
QMAKE         = /home/minjeong/Qt/5.13.0/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /home/minjeong/Qt/5.13.0/gcc_64/bin/qmake -install qinstall
QINSTALL_PROGRAM = /home/minjeong/Qt/5.13.0/gcc_64/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
...
DISTDIR = /home/minjeong/build-pcap_test-Desktop_Qt_5_13_0_GCC_64bit-Debug/.tmp/pcap_test1.0.0
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS) -lpcap   
AR            = ar cqs
...
DIST          = ../Qt/5.13.0/gcc_64/mkspecs/features/spec_pre.prf \
		...
		../pcap_test/pcap_test.pro pcap_test.h ../pcap_test/main.cpp
...
main.o: ../pcap_test/main.cpp ../pcap_test/pcap_test.h
